...
find /path/to/directory/ -newermt `ssh -t usernameremote@domain cat /home/usernameremote/.Logs/.date.txt` >> /home/username/.Backup/files.txt;
...
ssh -t usernameremote@domain 'date +%F -d today > /home/usernameremote/.Logs/.date.txt';
